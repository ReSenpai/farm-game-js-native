...
export const plants = [
    ...
    },
    {
        ...
        name: "Рис",
        description: "Очень требователен к условиям выращивания, может быть погублен заморозками. Рис очень любит влагу, и его побеги растут прямо из воды. Семена прорастают при 10—12 °C",
        growthTime: 40,
        itemCount: 10,
        resourceCost: 3,
    },
    {
        ...
        name: "Грибы",
        description: "Большинство мухоморов несъедобны или сильно ядовиты, есть опасные смертельно ядовитые виды (бледная поганка, мухомор вонючий), которые иногда путают со съедобными грибами. Общеизвестный мухомор красный в сыром виде и без должной обработки, кроме средней токсичности, обладает также галлюциногенным действием.",
        growthTime: 60,
        itemCount: 15,
        resourceCost: 7,
    },
    {
        ...
        name: "Кукуруза",
        description: "Кукуруза – один из самых древних однолетних злаков, известных человечеству. Найдены упоминания о том, что кукуруза была одомашнена почти 9 тыс. лет назад в Мексике.",
        growthTime: 30,
        itemCount: 20,
        resourceCost: 5,
    },
